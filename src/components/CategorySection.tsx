...
const CategorySection: React.FC = () => {
  ...
  return (
    <section className="px-6 md:px-12 py-16 bg-gradient-to-b from-white via-gray-50 to-gray-100">
      <div className="max-w-6xl mx-auto text-center mb-14">
        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
          Explore Our Categories
        </h2>
        <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
          Discover our premium selection of outdoor gear and accessories.
          Stylish, durable, and built to enhance every adventure.
        </p>
      </div>
